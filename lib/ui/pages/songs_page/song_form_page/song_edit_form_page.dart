...
class SongEditFormPage extends StatelessWidget {
  const SongEditFormPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    c
      ..textController.text = song.text
      ..executorController.text = song.executor
      ..nameController.text = song.name
      ..commentController.text = song.comment ?? "";
            ...
            TwoButtonsWidget(
              ...
              onTapTwo: () {
                if (c.nameController.text.isNotEmpty &&
                  ...
                  Get.find<SongsPageController>().editSong(newSong, song.id);
                  c.clearControllers();
                  Get.back();
                  Get.back();
                }
